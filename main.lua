...
function love.load()
    ...
    player1l = Paddle(10,(VIRTUAL_HEIGHT - 20) / 2 , 5, 20)
    player1r = Paddle(VIRTUAL_WIDTH - 15, (VIRTUAL_HEIGHT - 20) / 2, 5, 20)

    player2u = Paddle((VIRTUAL_WIDTH - 20) / 2, 10, 20 , 5)
    player2d = Paddle((VIRTUAL_WIDTH - 20) / 2, VIRTUAL_HEIGHT - 15, 20, 5)
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball:collides(player1l) then
        ...
        if ball:collides(player1r) then
            ball.dx = -ball.dx * 1.03
            ball.x = player1r.x - 4
        ...
        if ball:collides(player2u) then
        ...
        if ball:collides(player2d) then
            ball.dy = -ball.dy * 1.03
            ball.y = player2d.y - 4
    ...
    if love.keyboard.isDown('w') then
        player1r.dy = -PADDLE_SPEED
        player1l.dy = -PADDLE_SPEED
    ...
    if love.keyboard.isDown('left') then
        player2u.dx = -PADDLE_SPEED
        player2d.dx = -PADDLE_SPEED
